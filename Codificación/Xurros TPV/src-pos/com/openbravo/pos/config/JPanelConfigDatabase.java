...
public class JPanelConfigDatabase extends javax.swing.JPanel implements PanelConfig {
    ...
    private void initComponents() {
        ...
        add(jLabel4);
        jLabel4.setBounds(20, 160, 130, 16);
        ...
        add(jtxtDbDriverLib);
        jtxtDbDriverLib.setBounds(150, 40, 340, 26);

        jbtnDbDriverLib.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/fileopen.png"))); // NOI18N
        add(jbtnDbDriverLib);
        jbtnDbDriverLib.setBounds(500, 40, 30, 28);
        add(jtxtDbDriver);
        jtxtDbDriver.setBounds(150, 70, 180, 26);
        add(jtxtDbURL);
        jtxtDbURL.setBounds(150, 100, 340, 26);
        add(jtxtDbUser);
        jtxtDbUser.setBounds(150, 130, 180, 26);
